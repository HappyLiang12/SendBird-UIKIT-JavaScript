...
function ChannelPreview(_ref) {
  ...
  }, memoizedAvatar), React__default.createElement("div", {
  ...
  }, getTotalMembers(channel))), React__default.createElement(Label, {
...
function ChannelHeader(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    color: LabelColors.ONBACKGROUND_1
  }, title || LabelStringSet.CHANNEL_LIST__TITLE)), React__default.createElement("div", {
...
function AddChannel(_ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(IconButton, {
    ...
    width: "24px",
    height: "24px"
  })), showModal && React__default.createElement(InviteMembers, {
      ...
      case MessageStatusType.FAILED:
        {
          ...
          }, LabelStringSet.MESSAGE_STATUS__SENDING_FAILED, canResend && React__default.createElement(React__default.Fragment, null, React__default.createElement("span", {
            className: "sendbird-message-status__text__try-again",
            role: "button",
            tabIndex: 0,
            onClick: onResend,
            onKeyPress: onResend
          }, LabelStringSet.MESSAGE_STATUS__TRY_AGAIN), LabelStringSet.MESSAGE_STATUS__OR), React__default.createElement("span", {
...
function OutgoingUserMessage(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    type: LabelTypography.BODY_1,
    color: LabelColors.ONBACKGROUND_1
  }, message.message)), useReaction && message.reactions && message.reactions.length > 0 && React__default.createElement(EmojiReactions, {
...
function ThumbnailMessage(_ref) {
  ...
  return React__default.createElement("div", {
  ...
  }, !isByMe && React__default.createElement(React__default.Fragment, null, React__default.createElement(Avatar, {
  ...
  }, isByMe && React__default.createElement("div", {
    ...
    type: LabelTypography.CAPTION_3,
    color: LabelColors.ONBACKGROUND_2
  }, getMessageCreatedAt$2(message)), !isByMe && showReactionAddButton && React__default.createElement("div", {
    className: "sendbird-thumbnail__more",
    ref: parentContainRef,
    style: {
...
function OutgoingFileMessage(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    type: LabelTypography.BODY_1,
    color: LabelColors.ONBACKGROUND_1
  }, truncate(message.url, MAX_TRUNCATE_LENGTH)))), isMessageSent && useReaction && message.reactions && message.reactions.length > 0 && React__default.createElement(EmojiReactions, {
...
function IncomingFileMessage(_ref2) {
  ...
  return React__default.createElement("div", {
    ...
    type: LabelTypography.CAPTION_3,
    color: LabelColors.ONBACKGROUND_2
  }, getMessageCreatedAt(message)), showReactionAddButton && React__default.createElement("div", {
    className: "sendbird-file-message__more",
    ref: parentContainRef
  }, React__default.createElement(ContextMenu, {
    menuTrigger: function menuTrigger(toggleDropdown) {
...
function IncomingUnknownMessage(_ref3) {
  ...
  return React__default.createElement("div", {
    ...
    type: LabelTypography.BODY_1,
    color: LabelColors.ONBACKGROUND_2
  }, LabelStringSet.UNKNOWN__CANNOT_READ_MESSAGE)), React__default.createElement(Label, {
...
function MessageHoc(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    type: LabelTypography.CAPTION_2,
    color: LabelColors.ONBACKGROUND_2
  }, Moment(message.createdAt).format('LL'))), (message.isFileMessage && message.isFileMessage() || message.messageType === 'file') && React__default.createElement(React__default.Fragment, null, isImage(message.type) || isVideo(message.type) ? React__default.createElement(ThumbnailMessage, {
    disabled: disabled,
    message: message,
    userId: userId,
    isByMe: isByMe,
    ...
    toggleReaction: toggleReaction,
    memoizedEmojiListItems: memoizedEmojiListItems
  })), message.isAdminMessage && message.isAdminMessage() && React__default.createElement(AdminMessage, {
    message: message
  }), (message.isUserMessage && message.isUserMessage() || message.messageType === 'user') && React__default.createElement(Message, {
    message: message,
    disabled: disabled,
    isByMe: isByMe,
    userId: userId,
  ...
  _createClass(ConversationScroll, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", {
        ...
        return React__default.createElement(MessageHoc // show status for pending/failed messages
        , {
...
function ChatHeader(props) {
  ...
  }, memoizedAvatar, React__default.createElement(Label, {
...
var ConversationPanel = function ConversationPanel(props) {
  ...
  return React__default.createElement("div", {
    ...
    isActive: false,
    isMuted: false
  }), unreadCount > 0 && React__default.createElement(Notification, {
    count: unreadCount,
    onClick: function onClick() {
...
var MemebersAccordion = function MemebersAccordion(_ref) {
  ...
  }, LabelStringSet.CHANNEL_SETTING__MEMBERS__SEE_ALL_MEMBERS), members.length >= SHOWN_MEMBER_MAX && showMoreModal && React__default.createElement(Modal, {
    hideFooter: true,
    onCancel: function onCancel() {
...
function ChannelSettings(props) {
  ...
  return React__default.createElement("div", {
    ...
    type: LabelTypography.SUBTITLE_1,
    color: LabelColors.ONBACKGROUND_1
  }, "".concat(LabelStringSet.CHANNEL_SETTING__MEMBERS__TITLE, " (").concat(channel.members.length, ")")), React__default.createElement(Icon, {
